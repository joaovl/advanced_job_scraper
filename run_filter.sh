...
AI_BACKEND="--claude --claude-model opus"         # Most accurate
...
SCRAPE_CMD="python run_pipeline.py --location London --skip-workday --skip-playwright --skip-html --skip-remote --skip-company --parallel --claude-model opus"
