...
SEED = [
    ("BAE Systems",   "Senior FPGA Engineer",        "LinkedIn", True,  True,  9,  "VHDL and FPGA design for avionics, DO-178C and DO-254."),
    ...
    ("Airbus",        "Senior Avionics Developer",   "Workday",  False, True,  9,  "Avionics software, DO-178C, real-time C. Bristol."),
    ...
    with engine.begin() as c:
        ...
        for i, (co, title, src, comp, new, score, desc) in enumerate(SEED):
            ...
            c.execute(text(
                ...
                "ai_match, ai_reasons, first_seen, last_seen, search) VALUES "
                "(:k,:src,:co,:t,:loc,:u,:d,:comp,:isc,'open',:new,:sc,:m,:rz,:fs,:ls,"
                " to_tsvector('english', :ft))"),
